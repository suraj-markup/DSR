...
const Footer = () => {
    ...
    return (
        <footer ref={ref} className="relative bg-gradient-to-br from-primary via-accent to-primary pt-1">
            {/* CTA Banner Section */}
            <section className="relative bg-gradient-to-br from-accent via-orange-500 to-primary pt-16 md:pt-20 lg:pt-28 overflow-hidden">
                ...
                <div className="mx-4 md:mx-16 px-4 py-4 relative z-10">
                    <motion.div
                        ...
                        className="max-w-3xl"
                    >
                        <h2 className="font-display text-2xl sm:text-3xl md:text-4xl lg:text-5xl xl:text-6xl font-bold text-white ">
                ...
                <div className="bg-gray-900 text-white rounded-3xl md:rounded-4xl relative z-10 mx-2 md:mx-4 my-4 p-4 md:p-6">
                    <div className="mx-auto py-12 md:py-16">
                        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 gap-8 md:gap-12 lg:gap-8">
